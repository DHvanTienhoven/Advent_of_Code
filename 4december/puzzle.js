...
const findValidPassportsStrict = findValidPassports.filter(passport =>
    passport.byr <= 2002 && passport.byr >= 1920
    && passport.iyr >= 2010 && passport.iyr <= 2020
    && passport.eyr >= 2020 && passport.eyr <= 2030
    && (passport.ecl === "blu" || passport.ecl === "amb" || passport.ecl === "brn" || passport.ecl === "gry"|| passport.ecl === "grn"|| passport.ecl === "hzl" ||passport.ecl === "oth")
    // && (passport.hgt.match(/[150-193]cm/) || passport.hgt.match(/[60-76]in/))
    
    
    
    )

    console.log(findValidPassportsStrict.length)
    //this RegEx doesn't work
    console.log(findValidPassportsStrict.filter(passport => passport.hgt.match(/[150-193]cm/) || passport.hgt.match(/[60-76]in/)))